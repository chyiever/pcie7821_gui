...
a = Analysis(
    ...
    hiddenimports=['main', 'main_window', 'logger', 'config', 'pcie7821_api', 'acquisition_thread', 'data_saver', 'spectrum_analyzer', 'time_space_plot', 'realtime_filter', 'plot_interaction', 'tcp_tab3', 'tcp_tab3.tcp_types', 'tcp_tab3.tcp_tab3_manager', 'tcp_tab3.tcp_sender_worker', 'tcp_tab3.tcp_packet_builder', 'numpy', 'pyqtgraph', 'psutil', 'scipy', 'scipy.signal'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
